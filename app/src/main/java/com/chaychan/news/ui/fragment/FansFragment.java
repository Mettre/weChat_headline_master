 ...
 * 我的粉丝
 */
public class FansFragment extends BaseFragment<FollowPresenter> implements FollowListener<FollowBean>, BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void loadData() {
        ...
        mPresenter.getRefreshFansList(page, pageSize);
    }
